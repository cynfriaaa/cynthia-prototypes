...
export default function Home() {
  ...
  const prototypes = [
    ...
    {
      title: 'Sophisticated Puppies',
      description: 'A delightful blend of elegance and playful puppy animations',
      path: '/prototypes/puppy-elegance'
    },
